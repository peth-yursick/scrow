...
import { FormInvoice } from '@/lib/types';
import {
  Checkbox,
  FarcasterUserInput,
  InfoOutlineIcon,
                ...
                <Box>
                  ...
                  {localResolverType === 'kleros' && (
                    <AlertDescription fontSize="sm">
                      sCrow will only escalate claims to Kleros that are linked
                      to smart escrows holding tokens with a minimum value of
                      1000 USD at the time of locking the funds.
                    </AlertDescription>
                  )}
                </Box>
              </Alert>
          ...
          !isKnownResolver(localResolverType, chainId) ? (
            <>
              <FarcasterUserInput
                ...
                tooltip="Search for a Farcaster user to be your arbitrator in case of dispute."
                label="Arbitrator"
                placeholder="Search by username or fid..."
                localForm={localForm}
                helperText="Enter a Farcaster username or fid. The selected user's address will be used as the arbitrator."
                farcasterFidFieldName="arbitratorFid"
                farcasterUsernameFieldName="arbitratorUsername"
              />
              <Input
                name="resolverAddress"
                tooltip="Or enter a specific wallet address for the arbitrator."
                label="Or Enter Arbitrator Address"
                placeholder="0x..."
                localForm={localForm}
