...
import { chainLabelFromId, getChainName, unixToDateTime } from '@/lib/utils';
    ...
    <Document>
      ...
      <Page size="A4" style={styles.page}>
        ...
        <Text style={styles.disclaimer}>
          This document was generated by sCrow. It reflects terms set by the
          Client and Provider. sCrow is not responsible for the contents or
