...
The sCrow dApp is a Next.js application that serves as the interface for the sCrow protocol. It enables web3 freelancers to create and manage cryptocurrency invoices, securely hold funds in escrow, and resolve disputes through arbitration.

## Installation

To set up the sCrow dApp locally, follow these steps:

1. Clone the repository:

   ```bash
   git clone https://github.com/SmartInvoiceXYZ/smart-invoice.git
   cd smart-invoice/apps/dapp
   ```
