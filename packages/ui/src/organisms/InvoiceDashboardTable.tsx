...
import { InvoiceDisplayData } from '@scrow/graphql';
import { useInvoices, useIpfsDetails } from '@scrow/hooks';
import { getAccountString, getChainName } from '@scrow/utils';
import {
  CellContext,
  createColumnHelper,
  flexRender,
  ...
  if (!data?.length) {
    return (
      <Box paddingY={16}>
        ...
        >
          {isConnected ? (
            <Heading color="textMuted" size="lg">
    ...
    <Box paddingY={16} flex="1 0 100%">
      <Styles>
        <HStack justify="space-between" align="center" mb={8}>
          <Heading textAlign="left" color="text">
            My Invoices
          </Heading>
            ...
            {table.getRowModel().rows.map(row => {
              ...
              return (
                <Tr
                  ...
                  _hover={{ backgroundColor: 'muted', cursor: 'pointer' }}
                >
